...
Exercise 7: Examine the correlation between two different sets of variables from the Happy Grass data set. In your lab 4 assignment document, record the pair examined, the direction and strength of correlation, which test you used and why you chose this specfic correlation coefficient. 
```{r}
